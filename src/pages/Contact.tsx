          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
              ...
              <div className="flex gap-3">
                <a href="https://www.facebook.com/dborkahouse" target="_blank" rel="noopener noreferrer" onClick={() => trackContact("facebook")} aria-label="Facebook — Dubai Borka House" className="w-12 h-12 rounded-full bg-muted flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors"><Facebook className="w-5 h-5" /></a>
                <a href="https://www.instagram.com/dubaiborkahousebd" target="_blank" rel="noopener noreferrer" onClick={() => trackContact("instagram")} aria-label="Instagram — Dubai Borka House" className="w-12 h-12 rounded-full bg-muted flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors"><Instagram className="w-5 h-5" /></a>
                <a href="https://wa.me/8801845853634" target="_blank" rel="noopener noreferrer" onClick={() => trackContact("whatsapp")} aria-label="WhatsApp us" className="w-12 h-12 rounded-full bg-muted flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors"><MessageCircle className="w-5 h-5" /></a>
              </div>
            </motion.div>
